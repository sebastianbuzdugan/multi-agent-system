...
//		ag=createNewDedaleAgent(c, agentName, ExplorerAgent.class.getName(), entityParametersExplo1);
		...
		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, ExplorerAgent.class.getName(), entityParametersExplo2);
		...
		//4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, ExplorerAgent.class.getName(), entityParametersExplo3);
...
// 3) If you want to give specific parameters to your agent, add them here
		Object[] entityParametersExplo4 = {"Explo1", "Explo2", "Explo3"};

// 4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, ExplorerAgent.class.getName(), entityParametersExplo4);
        ...
        //4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, CollectorAgent2.class.getName(), entityParametersC);
        ...
        //4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, CollectorAgent2.class.getName(), entityParametersC2);
        ...
        //4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, CollectorAgent2.class.getName(), entityParametersC3);
        ...
        //4) Give the class name of your agent to let the system instantiate it
//		ag=createNewDedaleAgent(c, agentName, CollectorAgent2.class.getName(), entityParametersC4);
